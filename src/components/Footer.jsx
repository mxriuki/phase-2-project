...
const Footer = () => {
  return (
    <div
      id="Footer"
      className="border-t mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12 bg-gray-900"
    >
      <div className="flex flex-col items-center justify-center text-gray-100">
        ...
        <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
          <p className="hover:text-gray-400 text-base cursor-pointer leading-4">
            About
          </p>
          <p className="hover:text-gray-400 text-base cursor-pointer leading-4">
            Contact us
        ...
        <div className="flex items-center mt-6">
          <p className="text-base leading-4">
            2024<span className="font-semibold"> Caff</span>
          </p>
